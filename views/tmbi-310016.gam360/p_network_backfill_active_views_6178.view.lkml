view: p_network_backfill_active_views_6178 {
  sql_table_name: `tmbi-310016.gam360.p_NetworkBackfillActiveViews_6178`
    ;;
  ...
  dimension: action_count {
    type: number
    description: "The number of occurrences of a particular creative conversion."
    sql: ${TABLE}.ActionCount ;;
  }

  dimension: action_duration {
    type: number
    description: "The duration of a conversion action in seconds."
    sql: ${TABLE}.ActionDuration ;;
  }

  dimension: action_name {
    type: string
    description: "Name of the creative conversion, i.e. Play, Mute."
    sql: ${TABLE}.ActionName ;;
  }

  dimension: action_type {
    type: string
    description: "Type of the creative conversion, i.e. standard or custom."
  ...
  dimension: gfp_activity_ad_event_time {
    type: string
    description: "Event time from attributed conversion ad event for post Impression conversion.query_id.time_usec, for post click. Need to use string because format is inconsistent."
    sql: ${TABLE}.GfpActivityAdEventTime ;;
  }

  dimension: gfp_activity_ad_event_type {
    type: string
    description: "Indicates whether the conversion was post impression or post click."
    sql: ${TABLE}.GfpActivityAdEventType ;;
  }

  dimension: gfp_activity_id {
    type: number
    description: "Identifies a unique advertiser-site conversion ID."
    sql: ${TABLE}.GfpActivityId ;;
  }

  dimension: gfp_activity_name {
    type: string
    description: "User-specified name for gfp activity ID."
  ...
  dimension: is_measurable_impression {
    type: string
    description: "Indicates if the impression was measurable by ActiveView. Can be TRUE, FALSE, NA. Please use this field instead of the old MeasurableImpression"
    sql: ${TABLE}.IsMeasurableImpression ;;
  }

  dimension: is_viewable_impression {
    type: string
    description: "Indicates if the impression was viewable according to the IAB standard. Can be TRUE, FALSE, NA. Please use this field instead of the old ViewableImpression."
    sql: ${TABLE}.IsViewableImpression ;;
  }
  ...
  dimension: ord {
    type: string
    description: "The ord= parameter in all /activity requests."
    sql: ${TABLE}.Ord ;;
  }
  ...
  dimension: quantity {
    type: number
    description: "The qty= parameter in sales-related /activity requests."
    sql: ${TABLE}.Quantity ;;
  }
  ...
  dimension: revenue {
    type: string
    description: "The cost= parameter in sales-related /activity requests."
    sql: ${TABLE}.Revenue ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [action_name, gfp_activity_name]
  }
}
